...
<div id="busLineAddDiv">
	<form id="busLineAddForm" enctype="multipart/form-data"  method="post">
		...
		<div>
			...
			<span class="inputControl" id="removeinput1">
		...
		<div>
			...
			<span class="inputControl" id="removeinput2">
		...
		<div>
			...
			<span class="inputControl" id="removeinput3">
				<input class="textbox" type="text" id="busLine_tjzd" name="busLine.tjzd" style="width: 200px;"/>
			</span>
		</div>
		<div>
