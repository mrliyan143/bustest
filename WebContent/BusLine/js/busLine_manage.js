				...
				$.ajax({
					...
					success : function (busLine, response, status) {
						...
						if (busLine) { 
							...
							$("#removethis").remove("#busLine_tjzd_edit");
							$("#removethis").html('<input class="textbox" type="text" id="busLine_tjzd_edit" name="busLine.tjzd" style="width: 200px;"/>');
							$("#busLine_tjzd_edit").val(busLine.tjzd.split(','))
							$("#busLine_tjzd_edit").combobox({
							    url:'BusStation/listAll',
							    valueField: "stationId",
							    textField: "stationName",
							    panelHeight: "auto",
