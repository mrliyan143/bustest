	...
	<!-- 广告轮播开始 -->
	  <section id="main_ad" class="carousel slide" data-ride="carousel">
	    ...
	    <div class="carousel-inner" role="listbox">  
	      <div class="item active" data-image-lg="<%=basePath %>images/slider/side1.jpg" ></div>
	      <div class="item" data-image-lg="<%=basePath %>images/slider/side2.jpg" ></div>
	      <div class="item" data-image-lg="<%=basePath %>images/slider/side3.jpg" ></div>
	      <div class="item" data-image-lg="<%=basePath %>images/slider/slide_04_2000x410.jpg"></div>
	    </div>
	    <!-- 控制按钮 -->
